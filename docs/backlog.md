...
- Marc: Cursor → Dashboard → API Keys → create a user key (GitHub already connected to FitFight). Put `CURSOR_API_KEY` on Vercel Preview and Production. Do not paste the key in chat.
