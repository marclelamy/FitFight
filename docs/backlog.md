...
- Fight posts and a Feed tab: photos and short notes on a fight, aggregated across fights you are in; shared typed media object in Postgres + private Storage; report, delete own, and hide author (9 Sep 2026).
