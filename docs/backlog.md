...
**Current scope lock (9 Sep 2026):** four tabs (**Fights**, **New**, **Feed**, **You**); direct exact-username invitations; Steps × highest total; an optional fight title and optional typed loser action; 3-day, 1-week, 2-week, or 1-month durations; fight posts with photos, a short video, or text; Feed compose that picks a fight; recurring fights keep their feed; and a profile photo plus Apple Health step during onboarding. Do not restore friends, the old Requests tab, money, other metrics, alternate scoring, or removed settings unless Marc explicitly reopens that scope.
...
- **Richer challenge social.** Activity stats from other apps, and a friends feed outside fights. Fight-only photo/video/text feed shipped 9 Sep 2026. Do not invent extra feed tabs yet.
- **Next Apple Health Measure after Steps.** Marc 10 Sep 2026: start pulling more Apple Health activity so later fights are not Steps-only; WHOOP and other vendors stay later. Plan: [`research/apple-health-next-metrics.md`](research/apple-health-next-metrics.md). Recommended first type is **Active Energy** (Move calories) — Watch + WHOOP/Garmin/Strava already write it into Health. Do not pull Exercise Minutes or Stand (Watch-only zeros). Do not pull Distance as the next fight (same race as Steps). Do not warehouse unused Health types. Do not implement until this moves up; production scoring stays Steps. Marc still needs to pick: Active Energy next, stay Steps-only, or Distance.
...
- Current launch shape: Fights, New, Feed, and You; direct exact-username Steps challenges; optional fight title and optional loser action; 3/7/14/30-day durations; fight posts with photos, a short video, or text; Privacy and Support links; essential settings only.
...
- Fight posts and a Feed tab: photos, a short video, or a note on a fight; Feed + composes and picks a fight; recurring rounds keep the same feed; shared typed media object in Postgres + private Storage; report, delete own, and hide author (9 Sep 2026).
