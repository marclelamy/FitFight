...
- **Richer challenge social.** Videos, activity stats from other apps, and a friends feed outside fights. The first fight-only photo feed shipped 9 Sep 2026. Do not invent extra feed tabs yet.
